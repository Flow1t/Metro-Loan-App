...
st.set_page_config(page_title="Mutasi Bank – English", page_icon="🏦", layout="wide")
st.markdown(SHARED_CSS, unsafe_allow_html=True)
st.markdown(page_header("Mutasi Bank", "English Version", "Upload an XLSX bank mutation file with English column headers. Debit and Credit will be split automatically."), unsafe_allow_html=True)

st.sidebar.markdown("### 🏦 Mutasi Bank (English)")
st.sidebar.markdown("Reorganise XLSX mutations with English column format.")
