...
st.set_page_config(page_title="Mutasi MG")

st.sidebar.header("Mutasi Bank TXT file Parser")
...
def main():
    st.title("Mutasi Bank TXT File Parser")
    st.write("Upload your Mutasi Bank file. The app will extract loan details and subtotals, then generate downloadable CSV files.")
